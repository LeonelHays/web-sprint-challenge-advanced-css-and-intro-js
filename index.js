...
console.log('task 1.5', artists[2].name);
...
function get20s(array) {
  ...
  for(let i = 0; i < array.length; i++){
    if(array["years"] < "1900"){
  let newArray = array['name', "years"].split("/");
   }
  }
  return newArray
}
...
function addArtist(array) {
  array.push({ 
    ...
    bio: "has travelled a lot when he was young. He uses that expiriance to further his art"
  })
  return array
}
